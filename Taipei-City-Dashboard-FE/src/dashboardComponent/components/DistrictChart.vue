...
const districtFillColors = computed(() => {
	if (!isDiffMode.value) {
		const fills = {};
		districts.forEach(d => { fills[d] = districtColor.value; });
		return fills;
	}
	const dayColor = props.chart_config.color[0];
	const nightColor = props.chart_config.color[1];
	const fills = {};
	districts.forEach(d => {
		fills[d] = (districtData.value[d] ?? 0) >= 0 ? dayColor : nightColor;
	});
	return fills;
});
...
const districtData = computed(() => {
	...
	if (props.series.length === 1) {
		...
		if (firstItem !== null && typeof firstItem === "object" && "x" in firstItem) {
			// {x, y} object format
			data.forEach((item) => {
				output[item.x] = item.y;
				if (Math.abs(item.y) > highest) highest = Math.abs(item.y);
				sum += item.y;
			});
		} else {
			// numeric array format — use chart_config.categories as keys
			const categories = props.chart_config?.categories || [];
			categories.forEach((cat, i) => {
				const val = +data[i];
				if (!isNaN(val)) {
					output[cat] = val;
					if (Math.abs(val) > highest) highest = Math.abs(val);
					sum += val;
				}
			});
		}
...
<template>
  ...
  >
    <div class="districtchart-title">
      <h5>{{ chart_config.unit === '%' ? '平均' : '總合' }}</h5>
      <h6>{{ chart_config.unit === '%' ? Math.round(districtData.sum / (chart_config.categories?.length || 1)) : districtData.sum }} {{ chart_config.unit }}</h6>
      <div
        v-if="!isDiffMode"
        class="districtchart-title-legend"
      >
        <p>多</p>
        <div :style="{ backgroundColor: props.chart_config.color[0] }" />
        <p>少</p>
      </div>
      <div
        v-else
        class="districtchart-title-legend districtchart-title-legend--diff"
      >
        <p>日間多</p>
        <div
          :style="{
            background: `linear-gradient(to right, ${props.chart_config.color[0]}, ${props.chart_config.color[1]})`
          }"
        />
        <p>夜間多</p>
      </div>
      ...
      >
        ...
        >
          <path
            ...
            :fill-opacity="districtData['新莊區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['新莊區']) / districtData.highest)"
            :fill="districtFillColors['新莊區']"
          ...
          <path
            ...
            :fill-opacity="districtData['淡水區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['淡水區']) / districtData.highest)"
            :fill="districtFillColors['淡水區']"
          ...
          <path
            ...
            :fill-opacity="districtData['汐止區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['汐止區']) / districtData.highest)"
            :fill="districtFillColors['汐止區']"
          ...
          <path
            ...
            :fill-opacity="districtData['板橋區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['板橋區']) / districtData.highest)"
            :fill="districtFillColors['板橋區']"
          ...
          <path
            ...
            :fill-opacity="districtData['三重區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['三重區']) / districtData.highest)"
            :fill="districtFillColors['三重區']"
          ...
          <path
            ...
            :fill-opacity="districtData['樹林區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['樹林區']) / districtData.highest)"
            :fill="districtFillColors['樹林區']"
          ...
          <path
            ...
            :fill-opacity="districtData['土城區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['土城區']) / districtData.highest)"
            :fill="districtFillColors['土城區']"
          ...
          <path
            ...
            :fill-opacity="districtData['蘆洲區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['蘆洲區']) / districtData.highest)"
            :fill="districtFillColors['蘆洲區']"
          ...
          <path
            ...
            :fill-opacity="districtData['中和區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['中和區']) / districtData.highest)"
            :fill="districtFillColors['中和區']"
          ...
          <path
            ...
            :fill-opacity="districtData['永和區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['永和區']) / districtData.highest)"
            :fill="districtFillColors['永和區']"
          ...
          <path
            ...
            :fill-opacity="districtData['新店區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['新店區']) / districtData.highest)"
            :fill="districtFillColors['新店區']"
          ...
          <path
            ...
            :fill-opacity="districtData['鶯歌區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['鶯歌區']) / districtData.highest)"
            :fill="districtFillColors['鶯歌區']"
          ...
          <path
            ...
            :fill-opacity="districtData['三峽區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['三峽區']) / districtData.highest)"
            :fill="districtFillColors['三峽區']"
          ...
          <path
            ...
            :fill-opacity="districtData['瑞芳區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['瑞芳區']) / districtData.highest)"
            :fill="districtFillColors['瑞芳區']"
          ...
          <path
            ...
            :fill-opacity="districtData['五股區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['五股區']) / districtData.highest)"
            :fill="districtFillColors['五股區']"
          ...
          <path
            ...
            :fill-opacity="districtData['泰山區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['泰山區']) / districtData.highest)"
            :fill="districtFillColors['泰山區']"
          ...
          <path
            ...
            :fill-opacity="districtData['林口區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['林口區']) / districtData.highest)"
            :fill="districtFillColors['林口區']"
          ...
          <path
            ...
            :fill-opacity="districtData['深坑區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['深坑區']) / districtData.highest)"
            :fill="districtFillColors['深坑區']"
          ...
          <path
            ...
            :fill-opacity="districtData['石碇區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['石碇區']) / districtData.highest)"
            :fill="districtFillColors['石碇區']"
          ...
          <path
            ...
            :fill-opacity="districtData['坪林區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['坪林區']) / districtData.highest)"
            :fill="districtFillColors['坪林區']"
          ...
          <path
            ...
            :fill-opacity="districtData['三芝區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['三芝區']) / districtData.highest)"
            :fill="districtFillColors['三芝區']"
          ...
          <path
            ...
            :fill-opacity="districtData['石門區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['石門區']) / districtData.highest)"
            :fill="districtFillColors['石門區']"
          ...
          <path
            ...
            :fill-opacity="districtData['八里區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['八里區']) / districtData.highest)"
            :fill="districtFillColors['八里區']"
          ...
          <path
            ...
            :fill-opacity="districtData['平溪區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['平溪區']) / districtData.highest)"
            :fill="districtFillColors['平溪區']"
          ...
          <path
            ...
            :fill-opacity="districtData['雙溪區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['雙溪區']) / districtData.highest)"
            :fill="districtFillColors['雙溪區']"
          ...
          <path
            ...
            :fill-opacity="districtData['貢寮區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['貢寮區']) / districtData.highest)"
            :fill="districtFillColors['貢寮區']"
          ...
          <path
            ...
            :fill-opacity="districtData['金山區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['金山區']) / districtData.highest)"
            :fill="districtFillColors['金山區']"
          ...
          <path
            ...
            :fill-opacity="districtData['萬里區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['萬里區']) / districtData.highest)"
            :fill="districtFillColors['萬里區']"
          ...
          <path
            ...
            :fill-opacity="districtData['烏來區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['烏來區']) / districtData.highest)"
            :fill="districtFillColors['烏來區']"
        ...
        >
          <path
            ...
            :fill-opacity="districtData['北投區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['北投區']) / districtData.highest)"
            :fill="districtFillColors['北投區']"
          ...
          <path
            ...
            :fill-opacity="districtData['士林區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['士林區']) / districtData.highest)"
            :fill="districtFillColors['士林區']"
          ...
          <path
            ...
            :fill-opacity="districtData['內湖區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['內湖區']) / districtData.highest)"
            :fill="districtFillColors['內湖區']"
          ...
          <path
            ...
            :fill-opacity="districtData['中山區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['中山區']) / districtData.highest)"
            :fill="districtFillColors['中山區']"
          ...
          <path
            ...
            :fill-opacity="districtData['大同區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['大同區']) / districtData.highest)"
            :fill="districtFillColors['大同區']"
          ...
          <path
            ...
            :fill-opacity="districtData['中正區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['中正區']) / districtData.highest)"
            :fill="districtFillColors['中正區']"
          ...
          <path
            ...
            :fill-opacity="districtData['萬華區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['萬華區']) / districtData.highest)"
            :fill="districtFillColors['萬華區']"
          ...
          <path
            ...
            :fill-opacity="districtData['大安區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['大安區']) / districtData.highest)"
            :fill="districtFillColors['大安區']"
          ...
          <path
            ...
            :fill-opacity="districtData['信義區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['信義區']) / districtData.highest)"
            :fill="districtFillColors['信義區']"
          ...
          <path
            ...
            :fill-opacity="districtData['松山區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['松山區']) / districtData.highest)"
            :fill="districtFillColors['松山區']"
          ...
          <path
            ...
            :fill-opacity="districtData['南港區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['南港區']) / districtData.highest)"
            :fill="districtFillColors['南港區']"
          ...
          <path
            ...
            :fill-opacity="districtData['文山區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, Math.abs(districtData['文山區']) / districtData.highest)"
            :fill="districtFillColors['文山區']"
